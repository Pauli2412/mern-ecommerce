  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Conviértete en vendedor de la tienda LEBASSI</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>¿Te gustaría vender tus productos en LEBASSI?</h3>
                  <h5>Haz crecer tu negocio con LEBASSI</h5>
                  <b>Aplica hoy</b>
